...
class YOLOv8TFLiteDetector:
    def __init__(self, model_path: str, score_threshold: float = 0.05, num_threads: int = 1, enable_edgetpu: bool = False):
...
def main():
    ...
    detector = YOLOv8TFLiteDetector(model_path, score_threshold=0.05, num_threads=num_threads, enable_edgetpu=enable_edgetpu)
